...
#directories
wd_mammals <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Mammals'
wd_sps_occ <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Mammals/Occurrences'
wd_sps_range <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Mammals/Range_maps'
wd_shp <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Mammals/Regions_shapefile'
wd_fig_points <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Mammals/Figures/Points'
wd_fig_regs <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Mammals/Figures/Reference_regions'
wd_fig_graphs_nat <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Mammals/Figures/Graphs_nat'
wd_fig_graphs_alien <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Mammals/Figures/Graphs_alien'
wd_stats_nat <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Mammals/Stats/Native'
wd_stats_alien <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Mammals/Stats/Alien'
...
wd_var_cont <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Mammals/Variable_contribution'
...
#load alien mammal list
setwd(wd_mammals)
mamm <- read.csv('Mammal_checklist.csv')

#load selected species list
list <- readRDS('Selected_species')

#load mammals shapefile
...
for(i in 13:length(list))
{
  ...
  if(class(occ) != 'try-error'){
    ...
    sps_cl <- mamm[which(mamm$Species == list[i]),]
