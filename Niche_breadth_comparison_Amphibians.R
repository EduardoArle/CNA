...
#directories
wd_amphibia <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Amphibians'
wd_sps_occ <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Amphibians/Occurrences'
wd_sps_range <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Amphibians/Range_maps'
wd_shp <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Amphibians/Regions_shapefile'
wd_fig_points <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Amphibians/Figures/Points'
wd_fig_regs <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Amphibians/Figures/Reference_regions'
wd_fig_graphs_nat <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Amphibians/Figures/Graphs_nat'
wd_fig_graphs_alien <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Amphibians/Figures/Graphs_alien'
wd_stats_nat <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Amphibians/Stats/Native'
wd_stats_alien <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Amphibians/Stats/Alien'
...
wd_var_cont <- '/Users/carloseduardoaribeiro/Documents/CNA/Data/Amphibians/Variable_contribution'
...
#load alien amphibian list
setwd(wd_amphibia)
amph <- read.csv('Amphibia_checklist.csv')

#load selected species list
list <- readRDS('Selected_species')

#load amphibia shapefile
...
for(i in 2:length(list))
{
  ...
  if(class(occ) != 'try-error'){
    ...
    sps_cl <- amph[which(amph$Species == list[i]),]
    sps_alien_regs <- shp[which(shp$BENTITY2_N %in%
                                  sps_cl$Region),]
    
    #load species range map
    sps_range <- readOGR(list[i], dsn = wd_sps_range)
    sps_range_ext <- sps_range[which(sps_range$legend == 'Extant (resident)'),]
    ...
    if(!FALSE %in% sapply(nat_al_pts,nrow) > 0){
      ...
      regs_shp <- shp[which(shp$BENTITY2_N %in% regs),]
      bg_pts <- list()
      ...
      names(bg_pts) <- regs_shp$BENTITY2_N
